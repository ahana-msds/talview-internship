...
this folder contains practice files created to understand how errors occur in real programs, how to handle them safely using try and catch, and how to debug both synchronous and asynchronous code using developer tools.
...
- practice debugging techniques using logs and debugger statements
...
- how meaningful error messages help in faster debugging
- how different error types can be handled differently in pipelines
- how debugger helps inspect variable values step by step
- how async errors must be caught using try catch around await
- how debugging is more about finding wrong logic than syntax issues
